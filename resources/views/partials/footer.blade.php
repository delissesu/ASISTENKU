{{-- Footer Modern Universitas Jember Theme (Redesigned) --}}
<footer class="bg-brand-dark text-brand-yellow/80 py-12 border-t border-brand-primary/30">
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-12">
            ...
            <div class="lg:col-span-4 space-y-4">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('images/logo.png') }}" alt="ASISTENKU Logo" class="h-12 w-auto bg-white rounded-lg p-1">
                    <div>
                ...
                <p class="text-brand-yellow/60 text-sm leading-relaxed max-w-sm">
            ...
            <div class="lg:col-span-2 lg:ml-auto">
                ...
                <ul class="space-y-3 text-sm">
                    ...
                    <li><a href="#divisions" class="hover:text-brand-gold transition-colors">Divisi Lab</a></li>
                    <li><a href="#process" class="hover:text-brand-gold transition-colors">Alur Pendaftaran</a></li>
                </ul>
            </div>
             ...
             <div class="lg:col-span-2">
                ...
                <div class="flex gap-2">
                    <a href="#" class="p-2 bg-brand-primary rounded-lg hover:bg-brand-gold hover:text-brand-dark transition-all duration-300 group">
            ...
            <div class="lg:col-span-4">
                ...
                <ul class="space-y-4 text-sm">
                    <li class="flex items-start gap-3">
                        <x-heroicon-o-map-pin class="w-5 h-5 text-brand-gold shrink-0 mt-0.5" />
                        <span>Jl. Kalimantan Tegalboto No.37, Krajan Timur, Sumbersari, Jember, Jawa Timur 68121</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <x-heroicon-o-envelope class="w-5 h-5 text-brand-gold shrink-0" />
                        <a href="mailto:lab-fasilkom@unej.ac.id" class="hover:text-brand-gold transition-colors">lab-fasilkom@unej.ac.id</a>
                    </li>
                    <li class="flex items-center gap-3">
                        <x-heroicon-o-phone class="w-5 h-5 text-brand-gold shrink-0" />
        ...
        <div class="pt-8 border-t border-brand-primary/30 flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-sm text-brand-yellow/60 text-center md:text-left">
                &copy; {{ date('Y') }} Fakultas Ilmu Komputer Universitas Jember.
            </p>
             <div class="flex gap-6 text-sm text-brand-yellow/60">
