    ...
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-12">
            ...
            <div class="lg:col-span-2 lg:ml-auto">
                <h4 class="text-brand-dark font-bold mb-4">Menu</h4>
                <ul class="space-y-3 text-sm">
                    <li><a href="#" class="hover:text-brand-primary transition-colors">Beranda</a></li>
                    <li><a href="#divisions" class="hover:text-brand-primary transition-colors">Divisi Lab</a></li>
                    <li><a href="#process" class="hover:text-brand-primary transition-colors">Alur Pendaftaran</a></li>
                </ul>
            </div>

             <!-- Socials (Spans 2 columns) -->
             <div class="lg:col-span-2">
                <h4 class="text-brand-dark font-bold mb-4">Sosial Media</h4>
                <div class="flex gap-2">
                    <a href="#" class="p-2 bg-slate-50 border border-slate-100 rounded-lg hover:bg-brand-primary hover:text-white transition-all duration-300 group">
            ...
            <div class="lg:col-span-4">
                <h4 class="text-brand-dark font-bold mb-4">Kontak</h4>
                <ul class="space-y-4 text-sm">
                    <li class="flex items-start gap-3">
                        <x-heroicon-o-map-pin class="w-5 h-5 text-brand-primary shrink-0 mt-0.5" />
                        <span>Jl. Kalimantan Tegalboto No.37, Krajan Timur, Sumbersari, Jember, Jawa Timur 68121</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <x-heroicon-o-envelope class="w-5 h-5 text-brand-primary shrink-0" />
                        <a href="mailto:lab-fasilkom@unej.ac.id" class="hover:text-brand-primary transition-colors">lab-fasilkom@unej.ac.id</a>
                    </li>
                    <li class="flex items-center gap-3">
                        <x-heroicon-o-phone class="w-5 h-5 text-brand-primary shrink-0" />
