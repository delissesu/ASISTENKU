                        ...
                        <div class="p-6 pt-0">
                            <div class="grid md:grid-cols-4 gap-4 mb-4">
                                <div class="flex items-center gap-2 text-sm">
                                    ...
                                    <span class="text-slate-600">{{ $exam->start_time->format('d M Y') }}</span>
                                </div>
                                <div class="flex items-center gap-2 text-sm">
                                    <!-- Clock Icon -->
                                    ...
                                    <span class="text-slate-600">{{ $exam->start_time->format('H:i') }} ({{ $exam->duration_minutes }} menit)</span>
                                </div>
                            </div>
